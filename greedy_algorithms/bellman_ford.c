...
void bellman_ford(int graph[][VERTICES], int source);
void print_distances(int distances[VERTICES], int source);

int main(void) {
  int graph[VERTICES][VERTICES] = {{0, 6, INT_MAX, 7, INT_MAX},
                                   {INT_MAX, 0, 5, 8, -4},
